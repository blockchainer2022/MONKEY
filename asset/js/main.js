/*!
 * mma_monkeys: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var mma_monkeys = mma_monkeys || [];
 *   mma_monkeys.push(readyFunction);
 */
! function(t) {
    var e = {};
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function(t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.MMAMONKEYSEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var T, O = "resize.mma_monkeys orientationchange.mma_monkeys load.mma_monkeys";
    ...
    r.resize = b(c, O), r.scroll = b(c, "scroll.mma-monkeys resize.mma-monkeys orientationchange.mma-monkeys load.mma-monkeys"), r.redraw = b(), r.location = function(t) {
        window.location = t
    ...
    }, u(r.ready), S(), t.exports = window.mma_monkeys = r
}, function(t, e, n) {
    var r = n(178),
        i = n(232),
        o = n(58),
    ...
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.mma_monkeys\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="mint-mma-monkeys"></a>').attr("href", "https://mma_monkeys.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/mma_monkeys-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/mma_monkeys-badge-text.6faa6a38cd.svg").attr("alt", "Made in mma_monkeys"), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(f, l).on(f, l))
        }, n
    })
}, function(t, e, n) {
    "use strict";
    var r = window.$,
        i = n(64) && r.tram;
    /*!
     * mma_monkeys._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    r.define("edit", t.exports = function(t, e, n) {
        ...
        var i, o = t(window),
            ...
            c = "hashchange",
            s = n.load || function() {
                i = !0, window.MMAMONKEYSEditor = !0, o.off(c, l),
                    function(t) {
            ...
            f = !1;
        try {
            f = localStorage && localStorage.getItem && localStorage.getItem("MMAMONKEYSEditor")
        } catch (t) {}
    ...
    e.createPluginInstance = function(t) {
        var e = window.mma_monkeys.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function(t) {
        window.mma_monkeys.require("lottie").createInstance(t).stop()
    }
}, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
        ...
        T = function(t, e) {
            ...
            for (var w = 0, R = i.length; w < R; w++) {
                ...
                if (0 === w && (g = x[0]), S >= C) {
                    ...
                    var L = i[w + 1],
                        D = L && S !== C;
                    I = D ? L.actionItems[0] : null, D && (m = C / 100, T = (L.keyframe - C) / 100)
                }
            }
            var P = {};
            if (g && !I)
                for (var M = 0, j = a.length; M < j; M++) {
                    ...
                    for (var G = (A - m) / T, X = g.config.easing, k = h(X, G, f), V = 0, U = a.length; V < U; V++) {
                        var W = a[V],
                            B = y(s, W, g.config),
    ...
    r.define("scroll", t.exports = function(t) {
        var e = {
            ...
            f = "header, " + s + " > .header, " + s + " > .mint-nav:not([data-no-scroll])",
            l = 'a[href="#"]',
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function S(n, r) {
            ...
            a || (a = t.data(r, E, {
                ...
                config: {},
                selectedIdx: -1
            })), a.menu = i.find(".mint-nav-menu"), a.links = a.menu.find(".mint-nav-link"), a.dropdowns = a.menu.find(".w-dropdown"), a.dropdownToggle = a.menu.find(".w-dropdown-toggle"), a.dropdownList = a.menu.find(".w-dropdown-list"), a.button = i.find(".mint-nav-button"), a.container = i.find(".w-container"), a.overlayContainerId = "w-nav-overlay-" + n, a.outside = function(e) {
...
/**
 * ----------------------------------------------------------------------
 * mma_monkeys: Interactions 2.0: Init
 */
mma_monkeys.require('ix2').init({
    "events": {
        "e-5": {
            "id": "e-5",
            "name": "",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".mint-acco-item",
                            "selectorGuids": ["e6bece1f-e41f-2664-1f94-140a261a75ad"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "px",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".icon-mint",
                            "selectorGuids": ["31b0a1a0-f972-119d-6034-a7bbd6875351"]
                        },
                        "zValue": 180,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "12345678910|00000-11111-2222222-33333-4444444"
                            },
                            "globalSwatchId": "",
                            "rValue": 0,
                            "bValue": 0,
